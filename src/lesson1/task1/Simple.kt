 ...
 */
fun accountInThreeYears(i: Int, p: Int): Double =
        i * (1 + p / 100.0)*((1 + 1 * p / 100.0) + (1 + 1 * p / 100.0) * p / 100.0)
 ...
 * Необходимо вывести число, полученное из заданного перестновкой цифр в обратном порядке (например, 874).
 */
